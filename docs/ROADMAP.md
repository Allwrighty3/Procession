...
- [ ] Validate NPC behavior metadata during blueprint validation.
- [ ] Keep behavior validation inside generator validation small and explicit.
- [ ] Ensure invalid generated behavior metadata prevents unsafe world spawning.
...
- [ ] Add tests proving blueprints with valid behavior metadata pass validation.
- [ ] Add tests proving blueprints with invalid behavior metadata fail validation.
- [ ] Add tests proving NPCs without behaviors still spawn normally.
