defmodule Procession.Simulation.ResidentResourceCascadeMetricsRunTest do
  use ExUnit.Case, async: false

  alias Procession.Simulation.ResidentResourceCascadeExperiment

  @tag :resident_resource_metrics
  test "emit resident resource cascade evidence" do
    normal =
    ...
    IO.puts("RESIDENT_RESOURCE_EVIDENCE_BEGIN")
    IO.inspect(%{normal: normal, constrained: constrained}, pretty: true, limit: :infinity)
    IO.puts("RESIDENT_RESOURCE_EVIDENCE_END")
